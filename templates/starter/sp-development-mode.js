...
fs.readFile(packageJsonPath, 'utf8', (err, data) => {
  ...
  try {
    ...
    // Update the config environment to "development
    packageJsonData.config.environment = 'development';
    ...
    fs.writeFile(packageJsonPath, updatedJsonContent, 'utf8', (err) => {
      if (err) {
        ...
        console.log('Environment in package.json has been updated to "development"');
      }
    });
  } catch (jsonError) {
