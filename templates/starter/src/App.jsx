    ...
    <div className="flex flex-col w-full h-full bg-white">
      <header className="flex flex-col sm:flex-row gap-8 sm:gap-0  h-auto items-center px-6 py-4 justify-between" >
        ...
        <div className="flex gap-6">
          <a href="/wp-admin" class="flex relative rounded-lg items-center justify-center w-9 h-9 bg-zinc-50 border-zinc-200 border-[1.75px] rotate-45 cursor-pointer transistion-all duration-300 hover:bg-zinc-200">
          ...
          <a href="/" class="flex relative rounded-lg items-center justify-center w-9 h-9 bg-zinc-50 border-zinc-200 border-[1.75px] rotate-45 cursor-pointer transistion-all duration-300 hover:bg-zinc-200">
          ...
          <a href="https://github.com/Simplicity-Tech-Solutions/create-solid-press-starter" class="flex relative rounded-lg items-center justify-center w-9 h-9 bg-zinc-50 border-zinc-200 border-[1.75px] rotate-45 cursor-pointer transistion-all duration-300 hover:bg-zinc-200">
