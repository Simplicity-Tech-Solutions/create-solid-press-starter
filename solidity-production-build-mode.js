...
fs.readFile(packageJsonPath, 'utf8', (err, data) => {
  ...
  try {
    ...
    // Update the config environment to "production"
    packageJsonData.config.environment = 'production';
    ...
    fs.writeFile(packageJsonPath, updatedJsonContent, 'utf8', (err) => {
      if (err) {
        ...
        console.log('Environment in package.json has been updated to "production"');
      }
    });
  } catch (jsonError) {
